...
namespace UGG.Combat
{
    ...
    public class PlayerCombatSystem : CharacterCombatSystemBase
    {
        ...
        private Action<int> onMaterialize;
        ...
        protected override void Awake()
        {
            ...
            onMaterialize += dissolveController.SwitchWeapon;
        ...
        {
            if (_characterInputSystem.playerRAtkDown)
            {
                onMaterialize(2);
            }
        ...
        public void SwitchWeapon()
        {
            ...
            if (_characterInputSystem.GSWeapon&&isGS==false )
            {
                isGS = true;
                onMaterialize(1);
            }
            if (_characterInputSystem.Sword&&isGS==true)
            {
                isGS = false;
                onMaterialize(0);
            }
