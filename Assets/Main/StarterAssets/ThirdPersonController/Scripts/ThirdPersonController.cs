...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        string currentState;
        const string combat_Attack = "combat_Attack";
        const string combat_Attack2 = "combat_Attack2";
        ...
        //public bool GetLightAttackDown() =>
        ...
        private void Move()
        {
            ...
            isMove =targetSpeed < 0.1f ? false : true;
            if (isMove&&canMove)
            {
        ...
        public void canMovePlayer(float _waitTime)
        {
            //StartCoroutine(StopMoveWhenAttack());
            waitTime = _waitTime;           
        }
